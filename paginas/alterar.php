...
<html>
    ...
    <body id="fundo">
        ...
        <div class="formulario2">
            ...
            <form action="../controller/EditarAluno.php" method="POST">
                <label>Selecionar aluno:</label><br/>
                <label >CPF:</label>
                <input type="text"  name="cpf" placeholder="CPF do aluno"><br/>
                <label>Editar:</label><br/>
                <label >Nome:</label>
                <input type="text"  name="nome" placeholder="Novo nome" required><br/><br/>
                ...
                <label >Senha:</label>
                <input type="text"  name="senha" placeholder="Nova Senha" required><br/>
